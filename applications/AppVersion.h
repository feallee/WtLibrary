...
#define APP_VERSION_FULL \
    APP_VERSION_PRODUCT_NAME "_" APP_VERSION_BUILD_DATE "_" APP_VERSION_PRODUCT_NETWORK "_" APP_VERSION_PRODUCT_CUSTOMER "_" APP_VERSION_PRODUCT_FUNCTION "_" APP_VERSION_PRODUCT_PROTOCOL "_" APP_VERSION_TINY
#endif