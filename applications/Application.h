...
#define _APPLICATION_VERSION_TO_TEXT2(A, B) _APPLICATION_VERSION_TO_TEXT(A.B)
#define _APPLICATION_VERSION_TO_TEXT1(A) _APPLICATION_VERSION_TO_TEXT(A)

#if APP_CONFIG_PRODUCT_NAME_CURRENT == APP_CONFIG_PRODUCT_NAME_LB500
#define _APPLICATION_VERSION_TO_PRODUCT_NAME "LB500"
#elif APP_CONFIG_PRODUCT_NAME_CURRENT == APP_CONFIG_PRODUCT_NAME_LB600
#define _APPLICATION_VERSION_TO_PRODUCT_NAME "LB600"
#else
#error Configuration error, please configure macro APP_CONFIG_PRODUCT_NAME_CURRENT in AppConfig.h.
#endif

#if APP_CONFIG_CUSTOMER_NAME_CURRENT == APP_CONFIG_CUSTOMER_NAME_WT
#define _APPLICATION_CONFIG_CUSTOMER_NAME "WT"
#elif APP_CONFIG_CUSTOMER_NAME_CURRENT == APP_CONFIG_CUSTOMER_NAME_SR
#define _APPLICATION_CONFIG_CUSTOMER_NAME "SR"
#elif APP_CONFIG_CUSTOMER_NAME_CURRENT == APP_CONFIG_CUSTOMER_NAME_NU96
#define _APPLICATION_CONFIG_CUSTOMER_NAME "NU96"
#else
...
#elif APP_CONFIG_PROTOCOL_NAME_CURRENT == APP_CONFIG_PROTOCOL_NAME_IPV4
#define _APPLICATION_CONFIG_PROTOCOL_NAME "IPV4"
#elif APP_CONFIG_PROTOCOL_NAME_CURRENT == APP_CONFIG_PROTOCOL_NAME_IPV6
#define _APPLICATION_CONFIG_PROTOCOL_NAME "IPV6"
