...
#define LIB_COMMAND_REGISTER(group, name, action) \
     __attribute__((used, __section__(".LibCommand." #group))) const static LibCommand_Type mLibCommand##_##group##_##action = {name, action}
...
/// @param[in] name 应用程序命令名称。
/// @param[in] action 应用程序命令动作函数。
#define LIB_COMMAND_REGISTER5(name, action) LIB_COMMAND_REGISTER(51, name, action)

/// @brief 向应用程序命令分组 6 注册应用程序命令。
/// @param[in] name 应用程序命令名称。
/// @param[in] action 应用程序命令动作函数。
#define LIB_COMMAND_REGISTER6(name, action) LIB_COMMAND_REGISTER(61, name, action)

/// @brief 向应用程序命令分组 7 注册应用程序命令。
/// @param[in] name 应用程序命令名称。
/// @param[in] action 应用程序命令动作函数。
#define LIB_COMMAND_REGISTER7(name, action) LIB_COMMAND_REGISTER(71, name, action)

/// @brief 向应用程序命令分组 8 注册应用程序命令。
/// @param[in] name 应用程序命令名称。
/// @param[in] action 应用程序命令动作函数。
#define LIB_COMMAND_REGISTER8(name, action) LIB_COMMAND_REGISTER(81, name, action)
